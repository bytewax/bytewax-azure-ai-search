...
myst_url_schemes = {
    "gh-issue": {
        "url": "https://github.com/bytewax/bytewax-azure-ai-search/issues/"
        "{{ path }}#{{ fragment }}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
    "gh-path": {
        "url": f"https://github.com/bytewax/bytewax-azure-ai-search/blob/{git_id}"
        "#{path}}#",
        "title": "bytewax/bytewax-azure-ai-search{{ path }}",
        "classes": ["github"],
    },
    "http": None,
    "https": None,
...
autodoc2_packages = [
    {
        "path": "../src/bytewax/azure_ai_search/",
        "module": "bytewax.azure_ai_search",
    },
]
